...
root<-"/Users/acon/Desktop/_w/_p/SOfoodweb & EcoVelocity/Ecosystem network synthesis/Ecopath files/"
...
apply(McCormack$diet,2,sum,na.rm=TRUE)
...
calcPredConsume<-function( # returns vector of prey consumed
                ...
                ,Br  # vector - prey biomasses for predator
                ,a   # vector - prey availability to predator
                ,PBr # vector - resource (prey) productivity to biomass ratio
...
Holling2<-function( # returns vector proportion of max ingestion consumed
                  ...
                  ,I # vector - maximum ingestion rate of resources for predator
                  ,v # vector - vulnerability of prey to predator
                  ){
  mask<-I>0
  res<-I
  sum_vBr<-sum(v[mask]*Br[mask])
  res[mask]<-v[mask]*Br[mask]/(I[mask]+sum_vBr)
  return(res)
  }
